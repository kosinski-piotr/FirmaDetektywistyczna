    ...
    try
    {
        ...
        else
        {
            ...
            if ($wszystko_OK==true)
            {
                ...
                if ($polaczenie->query("INSERT INTO zlecenie VALUES (NULL,'Data: $termin<br />Godzina: $godzina',NULL,'Imie i nazwisko: $imie $nazwisko<br />Dane: $dane',5, {$_SESSION['id']})"))
                {
...
<head>
    ...
    <title>Sprawdzenie wierności</title>
...
<body>
    ...
    <div class="container">
        <h1>Sprawdzenie wierności współmałżonka/partnera</h1>
        <br />
        <br />
        <div class="row">
            <form method="post">
